...
<div class="cuerpo2">
                        ...
                        <form action="registrar.php" method="POST">
                                  <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ingresar nombre" id="name" name="nombre">
                                </div>
                                <div class="form-group">
                                        <label for="apellido"></label>
                                        <input type="text" class="form-control" placeholder="Ingresar Apellido" id="apellido" name="apellido">
                                </div>
                                <div class="form-group">
                                        <label for="rut"></label>
                                        <input type="text" class="form-control" placeholder="Ingresar Rut" id="rut" name="rut">
                                </div>
                                <div class="form-group">
                                        <label for="email"></label>
                                        <input type="email" class="form-control" placeholder="Ingresar email" id="email" name="email">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ingrese su direccion" id="direccion" name="direccion">
                                </div>
                                <div class="form-group">
                                        <label for="ciudad"></label>
                                        <input type="text" class="form-control" placeholder="Ingrese su Ciudad" id="ciudad" name="ciudad">
                                </div>
                                <div class="form-group">
                                        <label for="pwd"></label>
